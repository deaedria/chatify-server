...
const contactListModel = {
    getContactListByUserId: (req)=> {
        return new Promise((resolve, reject) => {
            db.query(`SELECT contacts_list.cl_id, contacts_list.contact_id, contacts_list.user_id, contacts.phone, contacts_list.contact_name, contacts_list.friend_photo FROM contacts LEFT JOIN contacts_list ON contacts_list.user_id = ${req.query.id} AND contacts_list.contact_id = contacts.contact_id WHERE contacts_list.contact_id is not null`, (err, result) => {
